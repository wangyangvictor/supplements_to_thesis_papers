...
\begin{itemize}
    ...
    % \rmk{
    % By [\href{https://arxiv.org/abs/0808.2169v1}{\texttt{arXiv:0808.2169v1}}, Proposition~3.2], we also have
    ...
    [\href{https://arxiv.org/abs/0808.2169v1}{\texttt{arXiv:0808.2169v1}}, first sentence of Remark~3.5] essentially states this without proof,\footnote{though (1), [Poo17, Corollary~7.5.21], and [\texttt{arXiv:0808.2169v1}, Theorem~2.4 or Skorobogatov (1992), after using a Veronese embedding]
    ...
    Thus $\set{q^{i/2}} = \mcal{E}^i(\PP^{N}_k)\belongs \mcal{E}^i(X)$, as desired.
    }
